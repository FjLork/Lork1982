		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empleados",
									"targetURL": "#lorkgroupfj82-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lorkgroupfj82-display": {
								"semanticObject": "lorkgroupfj82",
								"action": "display",
								"description": "Grupo Lorca",
								"title": "Empleados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lorkgroup.fj82",
									"url": sap.ui.require.toUrl("lorkgroup/fj82")
								}
							}
						}
					}
