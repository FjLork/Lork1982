sap.ui.define([
	...
	return Controller.extend("lorkgroup.fj82.controller.MasterEmployee", {
		...
		onFilter: function () {
			...
			console.log(aFilters);  // Imprime en consola los filtros creados
		...
		//------------------------------------------------------------------------------//
		//------------------------------------------------------------------------------//
		// Método para abrir un diálogo con información adicional
		...
		//------------------------------------------------------------------------------//
		//------------------------------------------------------------------------------//
		// Método para navegar a una vista de detalles de un empleado
